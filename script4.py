...
def Tweet_Mots_Cles(train_data):
    ...
    # Définir la fonction find_tweets_with_text
    def find_tweets_with_text(text):
        # Filtrer les tweets contenant le texte spécifié
        matching_tweets = train_data[train_data['Product_Description'].str.contains(text)]
        ...
        if type_produit != "Tous les produits":
    ...
    if st.button("Rechercher"):
        ...
        if search_text:
            ...
            matching_tweets = find_tweets_with_text(search_text)
